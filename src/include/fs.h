...
struct super_block
{
    ...
    unsigned int nr_inodes;       /**< How many inodes */
    unsigned int nr_sects;        /**< How many sectors */
    unsigned int nr_imap_sects;   /**< How many inode-map sectors */
    unsigned int nr_smap_sects;   /**< How many sector-map sectors */
    unsigned int n_1st_sect;      /**< Number of the 1st data sector */
    unsigned int nr_inode_sects;  /**< How many inode sectors */
    unsigned int root_inode;      /**< Inode nr of root directory */
    unsigned int inode_size;      /**< INODE_SIZE */
    unsigned int inode_isize_off; /**< Offset of `struct inode::i_size' */
    unsigned int inode_start_off; /**< Offset of `struct inode::i_start_sect' */
    unsigned int dir_ent_size;    /**< DIR_ENTRY_SIZE */
    unsigned int dir_ent_inode_off; /**< Offset of `struct dir_entry::inode_nr' */
    unsigned int dir_ent_fname_off; /**< Offset of `struct dir_entry::name' */
...
struct inode
{
    unsigned int i_mode;       /**< Accsess mode */
    unsigned int i_size;       /**< File size */
    unsigned int i_start_sect; /**< The first sector of the data */
    unsigned int i_nr_sects;   /**< How many sectors the file occupies */
